    ...
    def _scheduler_plan_start_calc(self, project):
        ...
        for task in tasks_list:
            ...
            tasks_ap.append({"id": task.id,
                             ...
                             "p_loop" : False,
                             "child_ids": len(task.child_ids.ids),
                             "sorting_level": task.sorting_level
                             })
            ...
            for predecessor in predecessors_list:
                predecessors_ap.append(
                    {"id": predecessor.id,
                     ...
                     "child_ids": len(predecessor.task_id.child_ids.ids),
                     "sorting_seq": predecessor.task_id.sorting_seq
                     })
